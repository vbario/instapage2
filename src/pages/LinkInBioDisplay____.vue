<template>
  <div class="landing-wrapper df fdc aic f1 w100p" @click="closeEmailCollection()">
    ...
    <!-- Item options when adding an item to the cart -->
    ...
    <!-- <div v-if="openedItemOptions || (openedItemOptions === 0)" class="." @click="openItemOptions(false)">
...
export default {
  ...
  methods: {
    ...
    openItemOptions (productId) {
      console.log('openedItemOptions', productId)
