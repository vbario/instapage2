<template>
  <div class="w100p whole-page df fdc jcsb">
    ...
    <div class="w100p df fdc aic mt10 mb10 h_" v-html="pageContent">
    </div>
  ...
  methods: {
    ...
    getPage (pageId) {
      this.$store.dispatch('AUTH.getPage', pageId).then((res) => {
        console.log('pageHtml', res)
        // let pageContent = res.htmlString
        let pageContent = res.aiHtml[0].message.content
